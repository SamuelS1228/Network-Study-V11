...
def plot_network(stores_df, centers):
    ...
    for _, row in stores_df.iterrows():
        ...
        r,g,b=_rgb(wh_idx)
        edges.append({'from':[row['Longitude'], row['Latitude']],
                      'to':[wh['Longitude'], wh['Latitude']],
                      'color':[r,g,b,180]})
    ...
    deck=pdk.Deck(layers=[edge_layer, store_layer, wh_layer], initial_view_state=view_state,
